...
from src.quality.news_expectations import save_quality_report, validate_news
from src.transform.news_transform import DEFAULT_LOCAL_SILVER_DIR, build_silver_object_name


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate Silver news quality rules.")
...
def main() -> None:
    ...
    print("News quality check completed")
